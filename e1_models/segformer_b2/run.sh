...
CONFIG="e1_models/segformer_b2/config.json"
SMOKE_DIR="e1_models/segformer_b2/runs/smoke"
FULL_DIR="e1_models/segformer_b2/runs/full_8k"
LOG_DIR="e1_models/segformer_b2/logs"
mkdir -p "${LOG_DIR}"
