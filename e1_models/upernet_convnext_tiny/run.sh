...
CONFIG="e1_models/upernet_convnext_tiny/config.json"
SMOKE_DIR="e1_models/upernet_convnext_tiny/runs/smoke"
FULL_DIR="e1_models/upernet_convnext_tiny/runs/full_8k"
LOG_DIR="e1_models/upernet_convnext_tiny/logs"
mkdir -p "${LOG_DIR}"
