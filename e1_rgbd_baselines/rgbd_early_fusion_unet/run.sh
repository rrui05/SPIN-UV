...
CONFIG="${CONFIG:-e1_rgbd_baselines/rgbd_early_fusion_unet/config.json}"
RUN_DIR="${RUN_DIR:-e1_rgbd_baselines/rgbd_early_fusion_unet/runs/rgbd_16k}"
LOG_DIR="${LOG_DIR:-e1_rgbd_baselines/rgbd_early_fusion_unet/logs}"
